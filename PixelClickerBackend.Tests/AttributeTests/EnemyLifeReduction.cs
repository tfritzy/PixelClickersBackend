...
namespace PixelClickerBackend
{
    ...
    public class enemyHealthPercentageReductionTests
    {
        ...
        public void TestLevelUpNotEquipt(){
            ...
            Assert.Equal(0f,
                        testPlayer.Stats.enemyHealthPercentageReduction);
        ...
        public void TestLevel1()
        {
            ...
            attr.ApplyEffect(testPlayer);
            Assert.Equal(applyFormula(1), testPlayer.Stats.enemyHealthPercentageReduction);
        }
        ...
        public void TestLevel2()
        {
            ...
            attr.ApplyEffect(testPlayer);
            Assert.Equal(applyFormula(2), testPlayer.Stats.enemyHealthPercentageReduction);
        }
        ...
        public void TestLevel3()
        {
            ...
            attr.ApplyEffect(testPlayer);
            Assert.Equal(applyFormula(3), testPlayer.Stats.enemyHealthPercentageReduction);
        }
        ...
        public void TestLevel4()
        {
            ...
            attr.ApplyEffect(testPlayer);
            Assert.Equal(applyFormula(4), testPlayer.Stats.enemyHealthPercentageReduction);
        }
        ...
        public void TestLevel5()
        {
            ...
            attr.ApplyEffect(testPlayer);
            Assert.Equal(applyFormula(5), testPlayer.Stats.enemyHealthPercentageReduction);
        }
        ...
        public void TestLevel10()
        {
            ...
            attr.ApplyEffect(testPlayer);
            Assert.Equal(applyFormula(10), testPlayer.Stats.enemyHealthPercentageReduction);
        }
        ...
        public void TestLevel100()
        {
            ...
            attr.ApplyEffect(testPlayer);
            Assert.Equal(applyFormula(100), testPlayer.Stats.enemyHealthPercentageReduction);
        }
        ...
        public void TestFlickerActive()
        {
            ...
            Assert.Equal(applyFormula(10), testPlayer.Stats.enemyHealthPercentageReduction);
            attr.RemoveEffect(testPlayer);
            Assert.Equal(0f, testPlayer.Stats.enemyHealthPercentageReduction);
        }
